...
class DaysRecordMachine extends RecordMachine
{
  ...
  public function getUserPosition($userName,$wardnumber=6){
   ...
   public function getUsersValueArray($time=18,$wardnumber=6){
    try{
      if($time < 0 && $time > 25){
...
$time_hour = $_POST['item'];//ポストで受け取れる
$number = $Yam->getUsersValueArray(($time_hour-5),6);
$html = $number;
...
// $Yam = new DaysRecordMachine();
// var_dump($Yam->getUsersValueArray(20,6));
